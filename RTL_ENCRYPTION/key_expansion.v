...
// Rewritten: fully unrolled key schedule (no procedural for-loop, no
// function calls nested inside a variable-bound loop). Functionally identical
// AES-128 key expansion, just expressed as 40 flat wire assignments instead of
// an always@(*) block with an integer-indexed for loop.
//////////////////////////////////////////////////////////////////////////////////

module key_expansion(
    input  [127:0] key,
    output [1407:0] all_keys
);
    ...
    function [31:0] subword;
        input [31:0] word;
        begin
            subword[31:24] = sbox_lut(word[31:24]);
            subword[23:16] = sbox_lut(word[23:16]);
            subword[15:8]  = sbox_lut(word[15:8]);
            subword[7:0]   = sbox_lut(word[7:0]);
        end
    endfunction
    ...
    wire [31:0] w4 = w0 ^ (subword(rotword(w3)) ^ (rcon(1) << 24));
    wire [31:0] w5 = w1 ^ w4;
    wire [31:0] w6 = w2 ^ w5;
    wire [31:0] w7 = w3 ^ w6;
    wire [31:0] w8 = w4 ^ (subword(rotword(w7)) ^ (rcon(2) << 24));
    wire [31:0] w9 = w5 ^ w8;
    wire [31:0] w10 = w6 ^ w9;
    wire [31:0] w11 = w7 ^ w10;
    wire [31:0] w12 = w8 ^ (subword(rotword(w11)) ^ (rcon(3) << 24));
    wire [31:0] w13 = w9 ^ w12;
    wire [31:0] w14 = w10 ^ w13;
    wire [31:0] w15 = w11 ^ w14;
    wire [31:0] w16 = w12 ^ (subword(rotword(w15)) ^ (rcon(4) << 24));
    wire [31:0] w17 = w13 ^ w16;
    wire [31:0] w18 = w14 ^ w17;
    wire [31:0] w19 = w15 ^ w18;
    wire [31:0] w20 = w16 ^ (subword(rotword(w19)) ^ (rcon(5) << 24));
    wire [31:0] w21 = w17 ^ w20;
    wire [31:0] w22 = w18 ^ w21;
    wire [31:0] w23 = w19 ^ w22;
    wire [31:0] w24 = w20 ^ (subword(rotword(w23)) ^ (rcon(6) << 24));
    wire [31:0] w25 = w21 ^ w24;
    wire [31:0] w26 = w22 ^ w25;
    wire [31:0] w27 = w23 ^ w26;
    wire [31:0] w28 = w24 ^ (subword(rotword(w27)) ^ (rcon(7) << 24));
    wire [31:0] w29 = w25 ^ w28;
    wire [31:0] w30 = w26 ^ w29;
    wire [31:0] w31 = w27 ^ w30;
    wire [31:0] w32 = w28 ^ (subword(rotword(w31)) ^ (rcon(8) << 24));
    wire [31:0] w33 = w29 ^ w32;
    wire [31:0] w34 = w30 ^ w33;
    wire [31:0] w35 = w31 ^ w34;
    wire [31:0] w36 = w32 ^ (subword(rotword(w35)) ^ (rcon(9) << 24));
    wire [31:0] w37 = w33 ^ w36;
    wire [31:0] w38 = w34 ^ w37;
    wire [31:0] w39 = w35 ^ w38;
    wire [31:0] w40 = w36 ^ (subword(rotword(w39)) ^ (rcon(10) << 24));
    wire [31:0] w41 = w37 ^ w40;
    wire [31:0] w42 = w38 ^ w41;
    wire [31:0] w43 = w39 ^ w42;

    assign all_keys = {w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, w19, w20, w21, w22, w23, w24, w25, w26, w27, w28, w29, w30, w31, w32, w33, w34, w35, w36, w37, w38, w39, w40, w41, w42, w43};
